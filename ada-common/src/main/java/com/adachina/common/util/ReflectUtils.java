...
public final class ReflectUtils {
	...
	public static String getDesc(Class<?> c) {
		...
		if (c.isPrimitive()) {
			appendPrimitive(ret, c.getName());
		} else {
			appendObject(ret, c.getName());
		}
		return ret.toString();
	}
	...
	public static Method findMethodByMethodSignature(Class<?> clazz, String methodName, String[] parameterTypes)
		...
		if (parameterTypes == null) {
			...
			checkFindedMethod(finded, methodName, clazz);
			method = finded.get(0);
		} else {
    ...
    private static void checkFindedMethod(List<Method> finded, String methodName, Class<?> clazz) throws NoSuchMethodException {
        if (finded.isEmpty()) {
	...
	public static Object getEmptyObject(Class<?> returnType) {
		return getEmptyObject(returnType, new HashMap<Class<?>, Object>(Const.DS_INITIAL_SIZE_MAP), 0);
	}
	...
	private static Object getEmptyObject(Class<?> returnType, Map<Class<?>, Object> emptyInstances, int level) {
		...
		Object returnObject = returnObjectByPrimierType(returnType);
		if(returnObject != null){
		    return returnObject;
        }
        returnObject = returnObjectByJavaClass(returnType);
		if(returnObject != null){
		    return returnObject;
        }
        if (!returnType.isInterface()) {
            return returnObjectByNonJavaInterface(emptyInstances, returnType, level);
        }else{
            return null;
        }
	}

	private static Object writeEmptyInstances(Map<Class<?>, Object> emptyInstances, Class<?> returnType) throws IllegalAccessException, InstantiationException {
    ...
    private static Object returnObjectByNonJavaInterface(Map<Class<?>, Object> emptyInstances, Class<?> returnType, int level) {
        try {
            Object value = writeEmptyInstances(emptyInstances, returnType);
    ...
    private static void setField(Field field, Object value, Object property) {
        try {
        	...
        	logger.info("reflect exception", e);
        }
    }

    private static Object returnObjectByJavaClass(Class<?> returnType) {
    ...
    private static Object returnObjectByPrimierType(Class<?> returnType) {
	...
	public static Map<String, Field> getBeanPropertyFields(Class cl) {
		Map<String, Field> properties = new HashMap<String, Field>(Const.DS_INITIAL_SIZE_MAP);
	...
	public static Map<String, Method> getBeanPropertyReadMethods(Class cl) {
		Map<String, Method> properties = new HashMap<String, Method>(Const.DS_INITIAL_SIZE_MAP);
		for (; cl != null; cl = cl.getSuperclass()) {
	...
	private static void appendPrimitive(StringBuilder ret, String t) {
		if (VOID.equals(t)) {
			ret.append(JVM_VOID);
	...
	private static void appendObject(StringBuilder ret, String name) {
		ret.append('L');
