package com.adachina.common.secure;
 ...
 * @Description
 * @Author litianlong
 * @Date 2019-03-22 11:43
 */
public class AdaAesUtil {
	private static final Logger logger = LoggerFactory.getLogger(AdaAesUtil.class);
	...
	private AdaAesUtil() {
		throw new IllegalStateException("AdaAesUtil Utility class");
	}
	/**
	 * 加密
	 * @author Charlotte
	...
	public static String encrypt(String content){ 
	        try {            
	                ...
	                secureRandom.setSeed(AdaAesUtil.KEY.getBytes());
